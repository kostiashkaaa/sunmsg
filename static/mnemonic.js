(function() {
    ...
    const WEB_CRYPTO_UNAVAILABLE_ERROR = "\u041A\u0440\u0438\u043F\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u044F \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0430 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430. \u041E\u0442\u043A\u0440\u043E\u0439\u0442\u0435 \u0441\u0430\u0439\u0442 \u043F\u043E HTTPS (\u0438\u043B\u0438 localhost). \u041D\u0430 iPhone \u0430\u0434\u0440\u0435\u0441 \u0432\u0438\u0434\u0430 http://192.168.x.x \u043D\u0435 \u043F\u043E\u0434\u0445\u043E\u0434\u0438\u0442.";

    const BIP39_WORDS = WORDLIST.split(' ');
    ...
    function normalizeMnemonicWords(mnemonic) {
    ...
    async function deriveKeyFromMnemonic(mnemonic, options = {}) {
        const cryptoApi = getWebCryptoOrThrow();
        const words = normalizeMnemonicWords(mnemonic);
        if (words.length < 12) {
            throw new Error("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043C\u0438\u043D\u0438\u043C\u0443\u043C 12 \u0441\u043B\u043E\u0432 (\u0438\u043B\u0438 \u0432\u0441\u0435 24 \u0434\u043B\u044F \u043F\u043E\u043B\u043D\u043E\u0439 \u0444\u0440\u0430\u0437\u044B).");
        }
        if (words.length > 24) {
            throw new Error("\u0421\u043B\u0438\u0448\u043A\u043E\u043C \u043C\u043D\u043E\u0433\u043E \u0441\u043B\u043E\u0432 \u0432\u043E \u0444\u0440\u0430\u0437\u0435. \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0432\u0432\u043E\u0434.");
        }
        ...
        const salt = encoder.encode("sun-messenger-v1-salt"); 
    ...
    async function createVault(mnemonic, privateKeyPem) {
        const cryptoApi = getWebCryptoOrThrow();
        const aesKey = await deriveKeyFromMnemonic(mnemonic);
    ...
    async function decryptVault(mnemonic, vaultStr) {
        try {
            const cryptoApi = getWebCryptoOrThrow();
            ...
            if (e.message.includes("\u041A\u0440\u0438\u043F\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u044F \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0430 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430")) throw e;
            throw new Error("\u041D\u0435\u0432\u0435\u0440\u043D\u0430\u044F \u0444\u0440\u0430\u0437\u0430. \u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0440\u0430\u0441\u0448\u0438\u0444\u0440\u043E\u0432\u0430\u0442\u044C \u043A\u043B\u044E\u0447.");
        }
    }
