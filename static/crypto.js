...
// Prefix marker for messages that decrypted fine but lack the sender's
// signature even though their public key is known to us. Previously such
// messages were silently shown as trusted — letting the server/a MITM
// inject an unsigned message. Now they are flagged explicitly. The marker
// is recognized by the renderer via this prefix (see message-rendering) and
// is not added to genuinely old messages with no known sender key.
